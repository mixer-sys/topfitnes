...
pytest_plugins = [
    ...
    'tests.fixtures.fixture_userinfo',
    'tests.fixtures.fixture_workoutsession',
    'tests.fixtures.fixture_category',
    'tests.fixtures.fixture_trainingvideo',
]

# test .md
default_md = '# begin_with_yourself_bot_1'
filename = 'README.md'
